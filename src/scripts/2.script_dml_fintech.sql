...
-- ATUALIZAR USUARIO
UPDATE usuario
SET nome = 'Ana Julia', sobrenome = 'De Mello', sexo = 2, data_nascimento = TO_TIMESTAMP('2014-10-10 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), email = 'anaju@example.com', data_hora_atualizacao = SYSTIMESTAMP
WHERE codigo = sq_usuario.CURRVAL;
...
INSERT INTO forma_pagamento (carteira_digital_codigo, tipo_pagamento_codigo)
VALUES (sq_carteira_digital.CURRVAL, 1);
...
INSERT INTO forma_pagamento (carteira_digital_codigo, tipo_pagamento_codigo)
VALUES (sq_carteira_digital.CURRVAL, 3);
...
UPDATE renda
SET valor_bruto = 4500.00, data_hora_atualizacao = SYSTIMESTAMP
WHERE codigo = sq_renda.CURRVAL;
...
UPDATE despesa
SET valor = 850.00, data_hora_atualizacao = SYSTIMESTAMP
WHERE codigo = sq_despesa.CURRVAL;
